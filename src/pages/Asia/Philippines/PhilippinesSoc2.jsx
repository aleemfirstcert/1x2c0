...
import imgsoc2 from "../../../assets/img/country/asia/philippines/soc2-img.webp";
import benefitssoc2 from "../../../assets/img/country/asia/philippines/soc2-benefits.webp";
import bgimg from "../../../assets/img/services/card-soc2.webp";
import EnquiryForm from "views/index-sections/EnquiryForm";

function PhilippinesSoc2() {
  const benefits = [
  ...
  const processSteps = [
    ...
    },
    {
      ...
      description:
        "Assistance in implementing and strengthening your controls with training and monitoring systems.",
    },
    {
      number: "5",
  ...
  return (
    <>
      <Helmet>
        <title>
          SOC 2 Certification in Philippines | Affordable SOC 2 Consultants – First Cert
        </title>
        <meta
          name="description"
          content="Looking for SOC 2 Certification in Philippines? First Cert provides expert consulting, documentation, implementation, and audit readiness support to help businesses achieve secure and compliant operations."
        />
        <meta
          name="keywords"
          content="SOC 2 Certification in Philippines, SOC 2 consultants in Philippines, SOC 2 audit Philippines, SOC 2 Type 1 certification Philippines, SOC 2 Type 2 certification Philippines, SOC 2 compliance Philippines, SOC 2 consulting company Philippines, SOC 2 certification cost Philippines, SOC 2 implementation Philippines, SOC 2 documentation Philippines, SOC 2 audit support Philippines, SOC 2 security compliance Philippines, First Cert SOC 2 consultants, SOC 2 certification for IT companies Philippines, SOC 2 for SaaS companies Philippines, SOC 2 cybersecurity certification Philippines."
        />
      </Helmet>
      ...
      >
        <div className="certificate-overlay">
          <h1 className="main-title">SOC 2 Certification in Philippines</h1>
        ...
        <div className="container">
          <div className="row align-items-center g-4">
            ...
            <div className="col-md-6">
              ...
              >
                Achieve <b>SOC 2 Certification in Philippines</b> with expert
      ...
      <section className="certificate-details-section">
        <div className="container">
          ...
          >
            <b>SOC 2 Certification in Philippines</b> is a globally recognized
          ...
          >
            ...
            frameworks. Businesses in Philippines gain improved credibility, stronger
          ...
          <section className="iso-section py-5">
            <div className="container">
              <h2 className="text-center mb-4 section-title">
                Which Businesses Need SOC 2 Certification in Philippines?
              </h2>
        ...
        <div className="container">
          ...
          <div className="row">
            <div className="col-12">
              <h1 className="text-primary fw-bold text-center mb-4">
                Benefits of Getting SOC 2 Certification in Philippines
              </h1>
            </div>
          </div>
          ...
          <div className="row">
            <div className="col-12">
              ...
              >
                With <a href="/">First Cert</a>, companies in Philippines achieve SOC 2
          ...
          <div className="row justify-content-center text-center mb-5">
            <div className="col-lg-10">
              <h2 className="display-5 fw-bold mb-3 text-primary">
                SOC 2 Certification in Philippines – Simplified Process with{" "}
      ...
      <div className="plans-wrapper py-5">
        ...
        <h2 className="text-center mb-4 main-heading text-primary">
          How Much Does SOC 2 Certification Cost in Philippines?
        </h2>
        ...
        <div className="container">
          <div className="row justify-content-center align-items-start">
            ...
            <div className="col-md-6 mb-4">
              ...
              >
                <div className="title small-title">
                  SOC 2 Certification cost in Philippines depends on:
                </div>
                ...
                <div className="title small-title">
                  First Cert’s SOC 2 consultants in Philippines provide transparent,
            ...
            <div className="col-md-6 mb-4">
              ...
              >
                <div className="title small-title">
                  Achieve SOC 2 Certification in Philippines with First Cert – Your
                  Trusted Partner in Security Compliance
                </div>
                <div className="title small-title">
                  If you want to achieve SOC 2 Certification in Philippines, First Cert
                ...
                <div className="title small-title">
                  ...
                  Certification journey today with First Cert — your partner in
                  achieving security excellence and global compliance.
                </div>
              </div>
            </div>
          </div>
...
export default PhilippinesSoc2;
