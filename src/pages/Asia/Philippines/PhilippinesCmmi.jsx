...
import imgcmmi from "../../../assets/img/country/asia/philippines/cmmi-img.webp";
import benefitscmmi from "../../../assets/img/country/asia/philippines/cmmi-benefits.webp";
import bgimg from "../../../assets/img/services/card-cmmi.webp";
import EnquiryForm from "views/index-sections/EnquiryForm";

function PhilippinesCmmi() {
  const benefits = [
  ...
  return (
    <>
      <Helmet>
        <title>
          CMMI Certification in Philippines | Best CMMI Consultants – First Cert
        </title>
        <meta
          name="description"
          content="Get CMMI Certification in Philippines with expert consulting, training, documentation, and appraisal support. Achieve CMMI Levels 2–5 efficiently with First Cert."
        />
        <meta
          name="keywords"
          content="CMMI Certification in Philippines, CMMI consultants in Philippines, CMMI Level 2 certification Philippines, CMMI Level 3 certification Philippines, CMMI Level 5 certification Philippines, CMMI appraisal in Philippines, CMMI implementation Philippines, CMMI certification cost Philippines, CMMI consulting company Philippines, CMMI SCAMPI appraisal Philippines, CMMI training in Philippines, CMMI documentation Philippines, CMMI process improvement Philippines, Capability Maturity Model Integration Philippines, CMMI for IT companies Philippines, CMMI for startups Philippines, best CMMI consultants Philippines, affordable CMMI certification Philippines, First Cert CMMI consultants."
        />
      </Helmet>
      ...
      >
        <div className="certificate-overlay">
          <h1 class="main-title">CMMI Certification in Philippines</h1>
          <p class="small-desc">
        ...
        <div className="container">
          <div className="row align-items-center g-4">
            ...
            <div className="col-md-6">
              ...
              >
                Achieve <b>CMMI Certification in Philippines</b> with the expert
              ...
              >
                ...
                assistance to help Philippines-based companies meet model requirements
                and successfully complete their official appraisal. <br />{" "}
                Strengthen process maturity, reduce risks, and build
                high-performing teams with <b>CMMI Certification in Philippines</b>{" "}
      ...
      <section className="certificate-details-section">
        <div className="container">
          ...
          >
            What is CMMI Certification in Philippines?
          </h2>
          ...
          >
            <b>CMMI Certification in Philippines</b> is a globally recognized process
          ...
          >
            Organizations across Philippines adopt CMMI to:
          </p>
          <div class="vapt-grid">
            <div class="vapt-card">
            ...
            <div class="vapt-card">
              <h5>Deliver predictable outcomes</h5>
            </div>
          ...
          <p
            ...
            style={{ color: "#000000", fontWeight: "400" }}
          >
            By achieving CMMI certification, businesses in Philippines demonstrate their
            commitment to excellence, making it easier to win enterprise
      ...
      <section className="iso-section py-5">
        <div className="container">
          <h2 className="text-center mb-4 section-title">
            Which Businesses Need CMMI Certification in Philippines?
          </h2>
          ...
          <p className="text-center section-sub mb-5">
            ...
            <b>CMMI Certification Implementation in Philippines</b>.
          </p>
          <p className="text-center section-sub mb-5">
              ...
              <div className="row g-4">
                <div className="col-md-4">
                  <div className="iso-card small-card">
                    ...
                    <p>
                      From established names in Philippines tech landscape to emerging
                      startups, CMMI helps build predictable, scalable
                ...
                <div className="col-md-4">
                  <div className="iso-card small-card">
                    ...
                    <p>Better control, efficiency, and service consistency.</p>
                  </div>
                </div>
                ...
                <div className="col-md-4">
                  <div className="iso-card small-card">
                    ...
                    <p>
                      Industries require strict process compliance and
                      consistency.
                    </p>
                  </div>
                </div>
                <div className="col-md-4">
                  <div className="iso-card small-card">
                    ...
                    <p>
                      Startups in the Philippines adopt CMMI to build strong process
        ...
        <p className="text-center section-sub mb-5">
          Implementing CMMI helps Philippines-based companies reduce risks, improve
          predictability, and increase customer confidence.
        </p>
      </section>
      ...
      <div className="iso-benefits-section py-5 bg-white">
        <div className="container">
          ...
          <div className="row">
            <div className="col-12">
              <h1 className="text-primary fw-bold text-center mb-4">
                Benefits of Getting CMMI Certification in Philippines
              </h1>
            </div>
          </div>
          ...
          >
            With <a href="/">First Cert</a>, achieving CMMI Certification in Philippines
            becomes a structured, strategic, and value-driven journey.
          </p>
        </div>
      </div>
          ...
          <div className="row justify-content-center text-center mb-5">
            <div className="col-lg-10">
              <h2 className="display-5 fw-bold mb-3 text-primary">
                CMMI Certification in Philippines – Simplified Process with First Cert
              </h2>
              <p
      ...
      <div className="plans-wrapper py-5">
        ...
        <h2 className="text-center mb-4 main-heading text-primary">
          How Much Does CMMI Certification Cost in Philippines?
        </h2>
        ...
        <div className="container">
          <div className="row justify-content-center align-items-start">
            ...
            <div className="col-md-6 mb-4">
              ...
              >
                <div className="title small-title">
                  The cost of CMMI Certification in Philippines depends on:
                </div>
            ...
            <div className="col-md-6 mb-4">
              ...
              >
                <div className="title small-title">
                  Achieve CMMI Certification in Philippines with First Cert – Your
                ...
                <div className="title small-title-p">
                  Start your CMMI Certification journey in the Philippines today with
...
export default PhilippinesCmmi;
