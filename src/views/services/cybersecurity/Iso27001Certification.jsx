...
import iso27001 from "../../../assets/img/services/iso-27001.webp";
...
function Iso27001Certification() {
  ...
  const steps = [
    {
      ...
      title: "Gap Analysis",
      desc: "Assessing your current information security practices against ISO 27001 requirements.",
    },
    {
      icon: <FaFileAlt size={28} className="text-success mb-2" />,
      title: "Documentation & Implementation",
      desc: "Creating and integrating ISMS documents and controls into your daily operations.",
    },
    {
      icon: <FaUsers size={28} className="text-warning mb-2" />,
      title: "Internal Audits & Training",
      desc: "Preparing your team for the certification audit and ensuring ongoing awareness.",
    },
    {
    ...
    },
    {
      ...
      desc: "Helping you stay compliant with surveillance audits and continuous improvement measures.",
    },
  ];
  ...
  const testimonials = [
    {
      quote:
        "First Cert made our ISO 27001 certification process smooth and stress-free. Their deep knowledge and structured guidance helped us achieve compliance ahead of schedule.",
      name: "Ravi Shankar",
    ...
    },
    {
      ...
      name: "Amechi",
      role: "IT Head, Wakanow",
    },
    {
      quote:
        "The professionalism and clarity from First Cert during our ISO 27001 project were exceptional. They managed everything from gap analysis to final audit with precision.",
      name: "Aisha Rahman",
      role: "IT Director, NexaSoft Technologies",
    },
    {
      quote:
        "We appreciated the team’s responsiveness and expertise. They made the complex process of ISO 27001 certification very straightforward.",
  ...
  return (
    <div>
      <Helmet>
        <title>
          ISO 27001 Certification | Information Security Experts – First Cert
        </title>
        <meta
          name="description"
          content="Want to know how to get ISO 27001 Certification with First Cert. Protect your data, minimize risks, and boost client trust through expert ISMS consulting and certified guidance."
        />
        <link rel="canonical" href="/Iso27001Certification" />
      </Helmet>
              ...
              <div className="col-12 col-xxl-11 px-0">
                ...
                <div className="text-content">
                  ...
                  <p className="lead fs-6 fs-md-5 fs-lg-4 text-white mb-3 mb-md-4">
                    ...
                    <b>ISO 27001 certification journey</b> — from consultation
                    to certification. With our assured certification guarantee,
                    your business can achieve compliance quickly and without
                    hassle.
                  </p>
                  <p className="lead fs-6 fs-md-5 fs-lg-4 text-white mt-3 mt-md-4">
                    <b>ISO 27001</b> is the global standard for{" "}
                    <b>Information Security Management Systems (ISMS)</b>,
                    helping organizations protect sensitive data, strengthen
                    customer trust, and enhance credibility. It provides a
                    structured approach to risk management, control
                    implementation, and continual improvement, ensuring your
                    business stays secure and compliant in today’s digital
                    world.
                  </p>
                </div>
              </div>
        ...
        <Row className="align-items-center">
          <Col lg={6} className="px-4 mb-4 mb-lg-0">
            <p className="lead text-dark mb-4 text-center text-lg-start">
              Gaining ISO 27001 certification sends a clear message: your
              organization values information security and customer trust.
              Certified companies benefit from:
            </p>
            <ul className="list-unstyled fs-5 text-start text-lg-start">
              <li className="mb-3">
                <span className="fw-semibold">
                  ✔ Stronger brand credibility and
                </span>{" "}
              ...
              <li className="mb-3">
                <span className="fw-semibold">✔ Increased ability</span> to win
                contracts, especially in regulated sectors
              </li>
              <li className="mb-3">
                <span className="fw-semibold">
              ...
              <li className="mb-3">
                ...
                in your handling of sensitive information
              </li>
            </ul>
            <p className="text-muted fs-5 mt-4 text-center text-lg-start">
              In today’s digital landscape, ISO 27001 is often the deciding
              factor in securing high-value partnerships and long-term client
              relationships.
            </p>
          </Col>
            ...
            <Col lg={10}>
              <div className="p-5 rounded-4 shadow-lg bg-white text-dark text-center">
                ...
                <p className="lead mb-4">
                  With First Cert, you gain more than just certification
                  assistance — you gain a partner dedicated to protecting your
                  business. Our expertise, industry-specific solutions, and
                  customer-focused approach ensure you achieve certification
                  quickly, without disrupting your operations.
                </p>
                <p className="mb-4">
                  If you’re ready to strengthen your information security,
                  enhance customer trust, and unlock new business opportunities,
                  contact First Cert today to start your ISO 27001 certification
                  journey.
                </p>
                <Button
                  variant="primary"
